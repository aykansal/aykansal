...
export interface Scalars {
  ...
  type: "file"
    ...
    BSHBSelect__1628697600: 'Architecture' | 'Redis' | 'OAuth' | 'Microservices' | 'Security' | 'Cryptography' | 'WhatsApp' | 'AI' | 'MCP' | 'Integrations',
    Boolean: boolean,
...
export type BlockDocument = (Blogs | BlogsItem | _AgentStart | blogsItem_AsList) & { __isUnion?: true }
...
export type BlockList = (Blogs | blogsItem_AsList) & { __isUnion?: true }
...
export interface BlogsItem {
    ...
    tags: Scalars['BSHBSelect__1628697600'][]
    __typename: 'BlogsItem'
}

export type BlogsItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'body__ASC' | 'body__DESC' | 'date__ASC' | 'date__DESC' | 'featured__ASC' | 'featured__DESC' | 'priority__ASC' | 'priority__DESC' | 'show__ASC' | 'show__DESC' | 'subtitle__ASC' | 'subtitle__DESC' | 'tags__ASC' | 'tags__DESC'
...
export interface _components {
    blogsItem: blogsItem_AsList
    __typename: '_components'
}

export interface blogsItem_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
...
export interface BlockDocumentGenqlSelection{
    ...
    on_Blogs?: BlogsGenqlSelection
    on_BlogsItem?: BlogsItemGenqlSelection
    on__AgentStart?: _AgentStartGenqlSelection
    on_blogsItem_AsList?: blogsItem_AsListGenqlSelection
    __typename?: boolean | number
...
export interface BlogsGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: BlogsItemGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: BlogsItemGenqlSelection
    __typename?: boolean | number
    __fragmentOn?: "Blogs"
}

export interface BlogsItemGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
    ...
    tags?: boolean | number
    __typename?: boolean | number
    __fragmentOn?: "BlogsItem"
}

export interface BlogsItemFilterInput {AND?: (BlogsItemFilterInput | null),OR?: (BlogsItemFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),date?: (DateFilter | null),featured?: (Scalars['Boolean'] | null),priority?: (NumberFilter | null),show?: (Scalars['Boolean'] | null),subtitle?: (StringFilter | null),tags?: (SelectFilter | null)}

export interface BlogsItemSearchInput {
...
export interface QueryGenqlSelection{
    ...
    blogs?: (BlogsGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (BlogsItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (BlogsItemOrderByEnum | null), 
    /** Search configuration */
    search?: (BlogsItemSearchInput | null), 
...
export interface _componentsGenqlSelection{
    blogsItem?: (blogsItem_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (BlogsItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
...
export interface blogsItem_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface FragmentsMap {
  ...
  Blogs: {
    root: Blogs,
    selection: BlogsGenqlSelection,
}
  BlogsItem: {
    root: BlogsItem,
    selection: BlogsItemGenqlSelection,
}
  Body: {
    root: Body,
  ...
  blogsItem_AsList: {
    root: blogsItem_AsList,
    selection: blogsItem_AsListGenqlSelection,
}
}
