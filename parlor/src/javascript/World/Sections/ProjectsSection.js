        ...
        this.list = [
            {
                ...
                imageSources:
                    [
                        './models/projects/ochidesign/ochi1.png',
                        './models/projects/ochidesign/ochi2.png',
                        './models/projects/ochidesign/ochi3.png',
                        './models/projects/ochidesign/ochi4.png',
                    ],
                floorTexture: this.resources.items.projectsOchiDesignFloorTexture,
                link:
                {
                    href: 'https://ochi.ayushkansal.me',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                    [
                        './models/projects/chartogne/bazar1.png',
                        './models/projects/chartogne/bazar2.png',
                        './models/projects/chartogne/bazar3.png',
                        './models/projects/chartogne/bazar4.png'
                    ],
                floorTexture: this.resources.items.projectsChartogneFloorTexture,
                link:
                {
                    href: 'https://bazarmash.ayushkansal.me',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                    [
                        './models/projects/bonhomme10ans/nftoodle1.png',
                        './models/projects/bonhomme10ans/nftoodle3.png',
                        './models/projects/bonhomme10ans/nftoodle4.png',
                        // './models/projects/bonhomme10ans/nftoodle5.png',
                        './models/projects/bonhomme10ans/nftoodle6.png'
                    ],
                floorTexture: this.resources.items.projectsBonhomme10ansFloorTexture,
                link:
                {
                    href: 'https://nftoodle.ayushkansal.me',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://boomar.ayushkansal.me',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
